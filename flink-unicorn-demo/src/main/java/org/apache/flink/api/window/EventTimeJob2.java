...
public class EventTimeJob2 {
	...
	public static void main(String[] args) throws Exception {
		...
		String filePath = EventTimeJob2.class.getResource("/stock.txt").getFile();
		...
		stockDataStream.assignTimestampsAndWatermarks(
			new BoundedOutOfOrdernessTimestampExtractor<Stock>(Time.seconds(2)) {
				@Override
