...
public class EventTimeJob1 {
	...
	public static void main(String[] args) throws Exception {
		...
		String filePath = EventTimeJob1.class.getResource("/stock.txt").getFile();
		...
		stockDataStream.assignTimestampsAndWatermarks(new AscendingTimestampExtractor<Stock>() {
														  @Override
														  public long extractAscendingTimestamp(Stock element) {
